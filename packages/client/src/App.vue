        ...
        <div class="app-shell">
          <header v-if="!inSession" class="app-header">
            ...
            <nav class="nav">
              ...
              <router-link v-if="ui.showTasks" to="/tasks" class="nav-link" :class="{ active: route.path.startsWith('/tasks') }">任务</router-link>
              <router-link v-if="ui.showProjects" to="/projects" class="nav-link" :class="{ active: route.path.startsWith('/projects') }">项目</router-link>
